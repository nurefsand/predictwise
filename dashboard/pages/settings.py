...
def _render_dashboard_preferences():
    with st.container(border=True, key="settings_card_prefs"):
        st.markdown('<div class="chart-title">Dashboard Preferences</div>', unsafe_allow_html=True)
...
def _render_model_information():
    st.markdown(
        '<div class="chart-card"><div class="chart-title">Model Information</div>',
        unsafe_allow_html=True
    )
...
def _render_risk_thresholds():
    st.markdown(
        '<div class="chart-card"><div class="chart-title">Risk Thresholds</div>'
...
def _render_export_settings():
    with st.container(border=True, key="settings_card_export"):
        st.markdown('<div class="chart-title">Export Settings</div>', unsafe_allow_html=True)
...
def _render_system_information():
    st.markdown(
        '<div class="chart-card"><div class="chart-title">System Information</div>',
        unsafe_allow_html=True
    )
